...
// Source: github.com/ozoncp/ocp-suggestion-api/internal/producer (interfaces: Producer)
...
import (
	...
	producer "github.com/ozoncp/ocp-suggestion-api/internal/producer"
)
...
func (m *MockProducer) Send(arg0 string, arg1 *producer.Message) error {
	m.ctrl.T.Helper()
